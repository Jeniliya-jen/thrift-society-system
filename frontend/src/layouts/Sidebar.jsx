...
const links = [
  ...
  { section: 'Reports' },
  { to: '/reports/pr200', label: '📄 PR200 - Subscription & Loan' },
  { to: '/reports/pr400', label: '📄 PR400 - Loan Recovery' },
  { to: '/reports/deposit', label: '📄 Thrift Deposit Register' },
  { to: '/reports/dividend', label: '📄 Dividend Payment' },
